...
import MedicalHistoryModal from "./components/AddMedicalHistory";
    ...
    },
    {
      ...
      accessor: (row) => (
        <Box as="span">
          ...
          <MedicalHistoryModal patientId={row._id} />
          <AppointmentForm patientId={row._id} fetchInfo={fetchPatients} />
